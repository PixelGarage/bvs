	...
	Drupal.behaviors.testimonials = {
		attach: function (context) {
			$('.node.node-testimonial', context).once(function() {
				$(this).hover(
        	function () {
            $(this).find('div.front, div.back').stop().rotate3Di('flip', 250, {direction: 'clockwise', sideChange: function() {
            	$(this).parent().find('div.front').hide();
            	$(this).parent().find('div.back').show();
            }});
        	},
        	function () {
        		$(this).find('div.front, div.back').stop().rotate3Di('unflip', 250, {direction: 'clockwise', sideChange: function() {
